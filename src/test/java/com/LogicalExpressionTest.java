...
public class LogicalExpressionTest extends BaseTest {
	...
	public void testOne() throws Exception {
		...
		assertTrue(cc.getPostCondition().getExpr() instanceof LogicalExpression);
		LogicalExpression bexpr = (LogicalExpression)cc.getPostCondition().getExpr();
	...
	public void testTwo() throws Exception {
		...
		assertNotNull(bexpr.getLeftExpression());
		assertTrue(bexpr.getLeftExpression() instanceof LogicalExpression);
		LogicalExpression bexpr0 = (LogicalExpression)bexpr.getLeftExpression();
